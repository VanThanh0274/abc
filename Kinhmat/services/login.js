...
export const apiUpgradeVip = async () => {
    const res = await api.post(`/CtrNguoidung/UpgradeVip`);
    return res.data;
}

export const apiVipProgress = async () => {
    const res = await api.get(`/CtrNguoidung/VipProgress`);
    return res.data;
}
