...
import { COLUMNS_NGUOIDUNG } from '../../../utils/exportConfigs';
...
export default function ProductsPage() {
  ...
  const handleExport = () => {
    const rows = listuser.map((u) => ({
      ...
      sdt: u.sdt || '',
      role: u.role,
      is_vip: u.is_vip === 1 ? 'VIP' : 'Thường',
      diachi: u.diachi || '',
    }));
    exportToExcel(rows, COLUMNS_NGUOIDUNG, 'NguoiDung', 'Người Dùng');
  };
  ...
  return (
    <div className={styles['order-page']}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
        ...
        <ExportButton
          label="Xuất Excel"
          options={[{ label: 'Xuất danh sách người dùng', onClick: handleExport }]}
        />
      </div>
